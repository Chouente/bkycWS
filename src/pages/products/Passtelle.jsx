...
import Chipses from '../../images/chipses.jpeg'
            ...
            <div className='PageContend'>
                        ...
                        <Row>
                            <Col md={6}>
                                <div className='ProductImage'>
                                    <img src={Passtelles} alt='caramel'/>
                                </div>
                            </Col>
                            <Col md={6}>
                ...
                <div className='container'>
                    <Row>
                        ...
                        <Col md={4}>
                            <a href='/product/chipse'>
                                <div className='cards'>
                                    <img src={Chipses} alt='chipses' />
                                    <h5> Chipses </h5>
                                </div>
                            </a>
                        </Col>
